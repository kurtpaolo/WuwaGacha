                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div className="space-y-1">
                      <p className="text-xs font-bold uppercase tracking-wide text-white">
                        Infinite Astrites &amp; All Banners
                      </p>
                      <p className="text-[11px] text-gray-300 font-mono leading-relaxed">
                        You are in local sandbox simulation. All pulls are free and unlimited. Rates mirror official 50/50 and pity systems. Data is stored locally and will not affect cloud accounts.
                      </p>
                    </div>
                  </div>

                  <div className="pt-2 flex flex-col sm:flex-row gap-2 border-t border-emerald-500/20">
                    {onResetSandbox && (
                      <button
                        type="button"
                        onClick={() => {
                        ...
                        className="flex-1 flex items-center justify-center space-x-2 py-2 px-3 rounded-xl bg-white/5 hover:bg-white/10 border border-white/15 text-xs font-mono font-bold text-gray-200 hover:text-white transition-all active:scale-95 cursor-pointer"
                        title="Reset pity counters and convene history in Sandbox"
                      >
                        <RotateCcw className="w-3.5 h-3.5 text-yellow-400" />
                        <span>Reset Pity &amp; History</span>
                      </button>
                    )}
                    ...
                    {onExitSandbox && (
                      <button
                        ...
                        className="flex-1 flex items-center justify-center space-x-2 py-2 px-3 rounded-xl bg-rose-500/20 hover:bg-rose-500/30 border border-rose-500/40 text-xs font-mono font-bold text-rose-300 hover:text-white transition-all active:scale-95 cursor-pointer"
                ...
                <div className="p-3.5 rounded-xl bg-white/[0.03] border border-white/10 space-y-3">
                  <div className="flex items-center justify-between flex-wrap gap-2">
                    <div className="space-y-0.5">
                      ...
                      <p className="text-[11px] text-gray-400 font-mono">
                        Simulate unlimited pulls freely without consuming your cloud Astrites.
                      </p>
                    </div>
                    ...
                    {onEnterSandbox && (
                      <button
                        ...
                        className="inline-flex items-center space-x-2 px-3.5 py-2 rounded-xl bg-emerald-500/20 hover:bg-emerald-500/35 border border-emerald-400/40 text-emerald-300 hover:text-white text-xs font-mono font-bold uppercase tracking-wider transition-all active:scale-95 cursor-pointer"
                      >
