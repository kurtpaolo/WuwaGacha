...
export const MILESTONE_TITLES: PlayerTitle[] = [
  // --- Starter / Special ---
  {
    ...
    name: "VIP",
    category: "special",
    description: "The chosen one. Unlocks +50% Free Astrites storage (+80 pulls / +6.0h). Combines with full login streaks for 24-hour capacity (51,200 Astrite / 320 pulls).",
    rarity: "mythic",
  ...
  // --- Daily Login Streak Titles (00:00 GMT+8 Resets, Permanent Unlocks) ---
  {
    ...
    category: "special",
    description: "Maintain a 2-day convene login streak. Permanently increases Free Astrites storage by +20 pulls (+1.5h).",
    rarity: "rare",
  ...
  },
  {
    ...
    category: "special",
    description: "Maintain a 5-day convene login streak. Permanently increases Free Astrites storage by +20 pulls (+1.5h).",
    rarity: "epic",
  ...
  },
  {
    ...
    category: "special",
    description: "Maintain a 9-day convene login streak. Permanently increases Free Astrites storage by +20 pulls (+1.5h).",
    rarity: "legendary",
  ...
  },
  {
    ...
    name: "Timeless Rover",
    category: "special",
    description: "Maintain a 14-day convene login streak. Permanently increases Free Astrites storage by +20 pulls (+1.5h).",
    rarity: "mythic",
